...
class FERFinal:
    def __init__(self):
        ...
        print("FER Final (RetinaFace) initialized successfully!")
    ...
    def predict(self, image):
        try:
            ...
            if dominant_emotion == 'neutral':
                sorted_emotions = sorted(emotion_confidences.items(), key=lambda x: x[1], reverse=True)
...
@app.route('/')
def index():
    return render_template('index_final_version.html')
