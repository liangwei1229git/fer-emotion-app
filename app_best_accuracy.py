...
class FERBestAccuracy:
    def __init__(self):
        ...
        print("FER Best Accuracy initialized successfully!")
    ...
    def predict_with_deepface(self, temp_path):
        try:
            ...
            return {
                ...
                'all_probabilities': emotion_confidences
            }
    ...
    def predict(self, image):
        try:
            ...
            result_df = self.predict_with_deepface(temp_path)
            ...
            dominant_emotion = result_df['emotion']
            confidence = result_df['confidence']
            emotion_confidences = result_df['all_probabilities']
